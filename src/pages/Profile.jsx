...
export default function Profile() {
  ...
  if (!profile) return (
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      <TopNav />
      <div style={styles.center}>Profile not found. <Link to="/">Go home</Link></div>
    </div>
  )
        ...
        <div style={styles.card}>
          ...
          <div style={{ padding: '0 24px 24px' }}>
            ...
            {profile.bio ? (
              ...
              <p style={styles.bioPlaceholder}>
                Add a bio so others know who you are.
              </p>
            ) : null}
          </div>
        </div>
...
const styles = {
  ...
  editBtn: {
    marginTop: 36, padding: '8px 14px', background: '#f1f5f9',
