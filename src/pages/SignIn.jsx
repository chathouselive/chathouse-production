      ...
      <footer style={styles.footer}>
        <div style={styles.footerInner}>
          <div style={styles.logo}>
            ...
            <span style={{ fontFamily: 'var(--serif)', fontWeight: 800, fontSize: 18 }}>Chathouse</span>
          </div>
          <div style={{ fontSize: 12, color: '#64748b' }}>
            © 2026 Chathouse · <a href="https://chathouselive.com" style={{ color: '#1a6cf5' }}>chathouselive.com</a>
          </div>
        </div>
      </footer>
...
const styles = {
  ...
  footer: { padding: '28px 20px', background: '#0f172a', color: '#fff' },
  footerInner: {
    maxWidth: 1160, margin: '0 auto',
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
